...
void tambahOwner(String email, String pass, String fname, String lname ,BuildContext context) async{
      try {
        final owneradd = {
          'email': email,
          'password': pass,
        ...
        if (email.isNotEmpty && pass.isNotEmpty && fname.isNotEmpty && lname.isNotEmpty) {
          ...
          if (response.statusCode == 200) {
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context) => daftar_owner2()));
          } else {
...
//function nambah cabang dan gudang (gabung jadi satu sj) 
  void nambahcabangngudang (String nama_cabang, String alamat_cabang , String no_telp, String alamat_gudang,  BuildContext context) async {
    try {
        final addcabang = {
        ...
        if (nama_cabang != null && alamat_cabang != null && alamat_cabang != null && no_telp != null) {
          ...
          if (response.statusCode == 200) {
            ...
            if (jsonData.isNotEmpty) {
              ...
              if (response2.statusCode == 200) {
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) => daftar_owner3()));
              }
            }else{
...
//tambah manager
    void tambahmanager(String email, String pass, String fname, String lname ,BuildContext context) async {
      final dataStorage = GetStorage();
