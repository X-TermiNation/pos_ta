...
//
void tambahpegawai(String email, String pass, String fname, String lname, String role) async{
      try {
        final useradd = {
          'email': email,
          'password': pass,
    ...
    //update user
    void UpdateUser(String fname, String lname, String role,String id, BuildContext context) async {
