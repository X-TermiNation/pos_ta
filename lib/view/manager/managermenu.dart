...
List<Map<String, dynamic>> databarang  = [];
  ...
  Widget build(BuildContext context) {
    ...
    bool isDateInRange(DateTime startDate, DateTime endDate) {
      return currentDate.isAtSameMomentAs(startDate) || currentDate.isAtSameMomentAs(endDate) ||
                              ...
                              child: Column(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                              ...
                                              : ListView.builder(
                                                ...
                                                itemBuilder: (context, index) {
                                                  return CheckboxListTile(
                                                    title: Text(databarang[index]['nama_barang'].toString()),
                                      ...
                                      FilledButton(
                                        onPressed: () async{
                                          String formattedDateStringStart = _dateFormat.format(selectedDateStart);
                                          DateTime insertedDateStart = _dateFormat.parse(formattedDateStringStart);

                                          String? DateStringStart;

                                          insertedDateStart = insertedDateStart.add(Duration(days: 1));
                                          DateStringStart = insertedDateStart.toIso8601String();

                                          String formattedDateStringEnd = _dateFormat.format(selectedDateEnd);
                                          DateTime insertedDateEnd = _dateFormat.parse(formattedDateStringEnd);

                                          String? DateStringEnd;

                                          insertedDateEnd = insertedDateEnd.add(Duration(days: 1));
                                          DateStringEnd = insertedDateEnd.toIso8601String();
                                          await tambahdiskon(nama_diskon.text,persentase_diskon.text,DateStringStart,DateStringEnd,isCheckedList,databarang,context);
                                  ...
                                  children: [
                                    ...
                                    FutureBuilder(
                                      ...
                                      if (snapshot.hasData) {
                                        ...
                                        .map((map) {
                                          var persentase = map['persentase_diskon'].toString();
                                          return DataRow(cells: [
                                            DataCell(Text(map['nama_diskon'].toString(), style: TextStyle(fontSize: 15))),
                                            DataCell(Text("$persentase %",style:TextStyle(fontSize: 15))),
                                            DataCell(Text(map['start_date'].toString().substring(0,10),style:TextStyle(fontSize: 15))),
                                            DataCell(Text(map['end_date'].toString().substring(0,10),style:TextStyle(fontSize: 15))),
                                            DataCell(
                                              Text(
                                                getStatus(DateTime.parse(map['start_date']), DateTime.parse(map['end_date'])),
                                          ...
                                          .toList();
                                            ...
                                            columns: const <DataColumn>[
                                              DataColumn(label: Text('Nama Diskon',style:TextStyle(fontSize: 15))),
                                              DataColumn(label: Text('Persentase Diskon',style:TextStyle(fontSize: 15))),
                                              DataColumn(label: Text('Tanggal Mulai',style:TextStyle(fontSize: 15))),
                                              DataColumn(label: Text('Tanggal Berakhir',style:TextStyle(fontSize: 15))),
                                              DataColumn(label: Text('Status',style:TextStyle(fontSize: 15))),
                                              DataColumn(label: Text('Hapus Diskon',style:TextStyle(fontSize: 15))),
                                            ],
                                            rows: rows,
                                          );
                        ...
                        FutureBuilder(
                          ...
                          builder: (context,snapshot){
                            if (snapshot.hasData) {
                                ...
                                return DataRow(cells: [
                                  DataCell(
                                    GestureDetector(
                                      ...
                                      child: Text(map['email'], style: TextStyle(fontSize: 15)),
                                    ),
                                  ),
                                  DataCell(Text(map['fname'],style:TextStyle(fontSize: 15))),
                                  DataCell(Text(map['lname'],style:TextStyle(fontSize: 15))),
                                  DataCell(Text(map['role'],style:TextStyle(fontSize: 15))),
                                  DataCell(
                                    Visibility(
                              ...
                              return DataTable(
                                columns: const <DataColumn>[
                                  DataColumn(label: Text('Email',style:TextStyle(fontSize: 15))),
                                  DataColumn(label: Text('First Name',style:TextStyle(fontSize: 15))),
                                  DataColumn(label: Text('Last Name',style:TextStyle(fontSize: 15))),
                                  DataColumn(label: Text('Role',style:TextStyle(fontSize: 15))),
                                  DataColumn(label: Text('Hapus Pegawai',style:TextStyle(fontSize: 15))),
                                ],
                                rows: rows,
                              );
                            }else if (snapshot.hasError) {
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: _isEditUser ? () {
                            UpdateUser(edit_fname.text,edit_lname.text,value2,temp_id_update,context);
                            setState(() {
                              edit_fname.text = "";
                              edit_lname.text = "";
                              _isEditUser = false;
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 32.0),
                    FilledButton(
                      onPressed: _isValidEmail ? () async {
                        try {
                          tambahpegawai(email.text, pass.text, fname.text, lname.text, value);
                          fetchUser();
                          getItems();
                          setState(() {
              ...
              children: <Widget>[
                Column(
                  ...
                  children: [
                    ...
                    ElevatedButton( 
                      child: const Text('Pindah Gudang'), onPressed: () =>
                      Navigator.push(context, MaterialPageRoute(builder: (context) => GudangMenu()))
                    ),
                    FilledButton(
                      onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) => managecabang()));}, 
